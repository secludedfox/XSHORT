// My first Addon...
chrome.runtime.onMessage.addListener(parse_short);
...
function bk_channel(){
    ...
    chrome.storage.local.set({"banned_channels" : new_blocked_channels.banned_channels});
...
let tmp_new_blocked_channels = chrome.storage.local.get();
